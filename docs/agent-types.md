...
If you want a minimal smoke test, the Hello World agent is the simplest option. If you need platform governance, use the Moderator. If you want to steer beliefs one target at a time, use Propaganda. If you want coordinated amplification through multiple managed accounts, use Master of Puppets.
